        ...
        <Stack className="absolute 2xl:h-[1025px] 3xl:h-[1230px] lg:h-[729px] xl:h-[911px] w-[100%]">
          ...
          <Column className="absolute bg-black_900_7f justify-start pb-[1px] pr-[1px] w-[100%]">
            <header className="w-[100%]">
              <Column className="bg-indigo_900 items-center justify-end p-[1px] w-[100%]">
                <Column className="justify-start xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[16px] lg:mt-[9px] w-[80%]">
                  <Row className="items-start lg:ml-[4px] xl:ml-[5px] 2xl:ml-[6px] 3xl:ml-[7px] w-[99%]">
                    <Text
                      className="cursor-pointer hover:font-bold 2xl:mt-[11px] 3xl:mt-[13px] lg:mt-[7px] xl:mt-[9px] text-white_A700_99 w-[auto]"
                      as="h2"
                      variant="h2"
                    >
                    ...
                    <Column className="items-center justify-start lg:ml-[13px] xl:ml-[16px] 2xl:ml-[19px] 3xl:ml-[22px] w-[7%]">
                      ...
                      />
                      <Text
                        className="cursor-pointer hover:font-bold font-normal lg:mt-[3px] xl:mt-[4px] 2xl:mt-[5px] 3xl:mt-[6px] not-italic text-white_A700_99 w-[auto]"
                        variant="body2"
                      >
                        Properties
                      </Text>
                    ...
                    <Column className="items-center justify-start lg:ml-[12px] xl:ml-[16px] 2xl:ml-[18px] 3xl:ml-[21px] w-[5%]">
                      ...
                      />
                      <Text
                        className="cursor-pointer hover:font-bold font-normal mt-[3px] not-italic text-white_A700_99 w-[auto]"
                        variant="body2"
                      >
                        Account
                      </Text>
          ...
          <Footer2 className="absolute bg-indigo_900 bottom-[0] py-[50px] w-[100%]" />
        </Stack>
      </Stack>
    </>
  );
