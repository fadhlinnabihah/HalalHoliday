            ...
            <Column className="items-center justify-start mt-[3px] w-[81%]">
              <Column className="justify-start w-[100%]">
                ...
                <Column className="absolute bottom-[0] items-center justify-start left-[11%] w-[8%]">
                  <Text
                    className="bg-bluegray_100_6c text-allign:center; font-bold font-ptsans 3xl:pb-[10px] lg:pb-[6px] xl:pb-[8px] 2xl:pb-[9px] lg:pt-[11px] xl:pt-[14px] 2xl:pt-[16px] 3xl:pt-[19px] lg:px-[4px] xl:px-[5px] 2xl:px-[6px] 3xl:px-[7px] text-white_A700_99 w-[100px]"
                    variant="body6"
                  >
                    Group homepage
                  </Text>
                  <Line className="bg-blue_600 h-[3px] mt-[2px] w-[85%]" />
                </Column>
